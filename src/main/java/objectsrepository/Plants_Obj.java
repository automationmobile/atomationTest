...
public class Plants_Obj
{
	...
	public static String mouseHover_Plants(WebDriver driver)
	{
		String val="//a[@href='/plants?promo=plants_tab_dt_hm']";
		return val;
	}
	public static String clickOn_BonsaiPlants(WebDriver driver)
	{
		String val="//a[@href='/bonsai-plants?promo=plantsmenu_dt_hm']";
		return val;
	}
	...
	public static String clickOn_CakeProduct(WebDriver driver)
	{
	...
	{
		String val="//ul[@class='timeslots']/li[@class='active']";
		return val;
	}
	...
	public static String verify_DeliveryDateInDeliveryDetailsPage(WebDriver driver)
	{
		String val="//div[@class='delivery-title']/following::div[1]";
		return val;
	}
	public static String verify_ShippmentMethod(WebDriver driver)
	{
	...
	public static String verify_DeliveryMethodInDeliveryDetailsPage(WebDriver driver)
	{
		String val="//div[@class='delivery-type']";
		return val;
	}
